...
`,
    ...
    Array.prototype.push = function () { // 将xxx修改为要hook的方法
        ...
        return temp_push.call(this, ...arguments); // 将网站js调用目标方法时所传入的内容传给原方法执行并返回结果
            ...
            {
                name: 'Hook_innerHTML',
                description: '当js通过元素的innerHTML属性设置元素内容时就会打印出元素，来源https://github.com/0xsdeo/Hook_JS',
                code: `(function () {
    'use strict';
    ...
    Object.defineProperty(Element.prototype, "innerHTML", {
        ...
        set: function () {
            ...
            {
                name: 'Hook_outerHTML',
                description: '当js通过元素的outerHTML属性设置元素内容时就会打印出设置的内容以及调用堆栈，来源https://github.com/0xsdeo/Hook_JS',
                code: `(function () {
    'use strict';
    ...
    Object.defineProperty(Element.prototype, "outerHTML", {
        ...
        set: function () {
            ...
            {
                name: 'Hook_CryptoJS',
                description: 'Hook CryptoJS 对称&哈希&HMAC 所有算法，来源https://github.com/0xsdeo/Hook_JS/blob/main/Hook_CryptoJS/Hook_CryptoJS.js',
                code: `(function () {
    'use strict';
    ...
    Function.prototype.apply = function () {
        ...
        return temp_apply.call(this, ...arguments);
            ...
            },
            {
                ...
                description: '该脚本可绕过：new 函数 --> 调试器，构造函数 --> 调试器，eval -->调试器,来源https://github.com/0xsdeo/Bypass_Debugger',
                code: `(function () {
    'use strict';
    ...
    Function.prototype.constructor.prototype = Function.prototype;
            ...
            {
                name: 'Hook_close',
                description: '重写close方法，以此来避免网站反调试关闭当前页面,来源https://github.com/0xsdeo/Hook_JS/blob/main/hook_window/hook_close.js',
                code: `(function() {
    'use strict';
